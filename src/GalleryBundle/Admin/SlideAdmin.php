...
use GalleryBundle\Entity\Slide;
...
class SlideAdmin extends Admin 
{
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper->with('Slide')
            ...
            ->add('parentGallery', 'entity', ['class' => 'GalleryBundle\Entity\GalleryPage'])
    ...
    protected function configureListFields(ListMapper $listMapper)
    {
        $listMapper
            ...
            ->add('displayOrder')
            ->addIdentifier('content', null, ['template' => 'GalleryBundle:Admin:fields/image_preview.html.twig'])
        ;
    }
