...
class GalleryPage
{
     ...
     * Add slides
     *
     * @param \GalleryBundle\Entity\Slide $slides
     * @return GalleryPage
     */
    public function addSlide(\GalleryBundle\Entity\Slide $slides)
    {
        $this->slides[] = $slides;
     ...
     * @param \GalleryBundle\Entity\Slide $slides
     */
    public function removeSlide(\GalleryBundle\Entity\Slide $slides)
    {
