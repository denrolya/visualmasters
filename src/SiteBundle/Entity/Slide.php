 ...
 * @ORM\Entity(repositoryClass="SiteBundle\Repository\SlideRepository")
 */
class Slide
{
    const REPOSITORY_CLASS = "SiteBundle:Slide";
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SiteBundle\Entity\GalleryPage", inversedBy="slides", cascade={"persist"})
     ...
     * Set parentGallery
     *
     * @param \SiteBundle\Entity\GalleryPage $parentGallery
     * @return Slide
     */
    public function setParentGallery(\SiteBundle\Entity\GalleryPage $parentGallery = null)
    {
     ...
     * Get parentGallery
     *
     * @return \SiteBundle\Entity\GalleryPage
     */
