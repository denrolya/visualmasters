 ...
 * @ORM\Entity(repositoryClass="Application\GalleryBundle\Entity\SlideRepository")
 */
class Slide
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Application\GalleryBundle\Entity\GalleryPage", inversedBy="slides", cascade={"persist"})
     ...
     * Set parentGallery
     *
     * @param \Application\GalleryBundle\Entity\GalleryPage $parentGallery
     * @return Slide
     */
    public function setParentGallery(\Application\GalleryBundle\Entity\GalleryPage $parentGallery = null)
    {
