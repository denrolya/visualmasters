...
return $this->services['security.firewall.map.context.admin'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 2 => ${($_ = isset($this->services['security.logout_listener.admin']) ? $this->services['security.logout_listener.admin'] : $this->load('getSecurity_LogoutListener_AdminService.php')) && false ?: '_'};
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.form.admin']) ? $this->services['security.authentication.listener.form.admin'] : $this->load('getSecurity_Authentication_Listener_Form_AdminService.php')) && false ?: '_'};
    yield 4 => ${($_ = isset($this->services['security.authentication.listener.anonymous.admin']) ? $this->services['security.authentication.listener.anonymous.admin'] : $this->load('getSecurity_Authentication_Listener_Anonymous_AdminService.php')) && false ?: '_'};
